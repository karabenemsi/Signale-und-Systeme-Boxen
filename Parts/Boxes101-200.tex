...
\begin{abox}
	\mathcal{Z}\{k\cdot\alpha^k\cdot\epsilon[k]\} &= -z \cdot \frac{d}{dz}\mathcal{Z}\{\alpha^k\epsilon[k]\} = -z \cdot \left(\frac{z}{z - \alpha}\right)' = -z \cdot \left(\frac{1 \cdot (z - \alpha) - z \cdot 1}{(z - \alpha)^2}\right) = \frac{\alpha\cdot z}{(z - \alpha)^2}
\end{abox}
...
\begin{abox}
	\frac{p^{-1}}{z-(a+p)} \sLaplace p^{-1}(a+p)^{K-1} \epsilon[K-1]\text{ und }\frac{p^{-1}}{z-1} \sLaplace p^{-1}1^{K-1}\epsilon[K-1] = p^{-1}\epsilon[K-1]
\end{abox}
