...
\begin{abox}
	\mathcal{Z}\{\alpha x[k] + \beta y[k]\} &\overset{Def.}{=} \sum_{k = -\infty}^{\infty}(\alpha x[k] + \beta y[k]) \cdot z^{-k}\\
	&= \alpha (\sum_{k = -\infty}^{\infty}x[k]z^{-k}) + \beta (\sum_{k = -\infty}^{\infty}y[k]z^{-k})\\
	&= \alpha X(z) + \beta Y(z)
\end{abox}
...
\begin{abox}
	\mathcal{Z}\{a^k \cdot x[k]\} \overset{Def.}{=} \sum_{k = -\infty}^{\infty}\underbrace{a^k}_{=(\frac{1}{\alpha})^{-k}} \cdot x[k] \cdot z^{-k} = \sum_{k = -\infty}^{\infty}x[k] \cdot (\frac{z}{\alpha})^-k = X(\frac{z}{\alpha})
\end{abox}

\begin{abox}
	\mathcal{Z}\{x[-k]\} = \sum_{k = -\infty}^{\infty}x[-k]z^{-k} \underset{(k = -k')}{\overset{k' = -k}{=}} \sum_{k' = -\infty}^{\infty}x[k']z^{k'} = \sum_{k' = -\infty}^{\infty}x[k'] \cdot (\frac{1}{z})^{-k'} = X(\frac{1}{z})
\end{abox}
...
\begin{abox}
	\mathcal{Z}\{k\cdot\alpha^k\cdot\epsilon[k]\} &= -z \cdot \frac{d}{dz}\mathcal{Z}\{\alpha^k\epsilon[k]\} = -z \cdot (\frac{z}{z - \alpha})' \\
	&= -z \cdot (\frac{1 \cdot (z - \alpha) - z \cdot 1}{(z - \alpha)^2}) = \frac{\alpha\cdot z}{(z - \alpha)^2}
\end{abox}
...
\begin{abox}
	y[k + 1] &= y[k] \cdot (1 + p) +  x[k + 1]\\
	zY(z) &= Y(z) \cdot (1 + p) + zX(z) \Leftrightarrow Y(z)(z - (1 + p)) = zX(z)
\end{abox}
